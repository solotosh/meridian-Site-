            ...
            <form method="POST" action="{{ route('admin.contact.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email2" class="form-control" value="{{ old('email2', $contact->email2 ?? '') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone2" class="form-control" value="{{ old('phone2', $contact->phone2 ?? '') }}">
                    </div>
