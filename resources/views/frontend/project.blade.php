...
<!-- Page Title -->
<section class="page-title-two bg-color-1 centred py-5">
...
<style>
    ...
    .projects-section {
    margin-top: 100px; /* or whatever you prefer */
}
...
<!-- Projects List -->
<section class="property-details property-details-one py-5 projects-section">
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    ...
                                    <div class="buy-btn pull-right">
                                        <span class="btn btn-sm btn-outline-primary">See Details</span>
                                    </div>
                                </div>
                            ...
                            <div class="lower-content">
                                ...
                                <div class="price-box clearfix">
                                    <ul class="other-option pull-right clearfix">
                                        <li><a href="{{ url('projects/' . $item->id) }}"><i class="fas fa-map-marked-alt"></i></a></li>
                                        <li><a href="{{ url('projects/' . $item->id) }}"><i class="fas fa-crosshairs"></i></a></li>
                                    </ul>
                                </div>
